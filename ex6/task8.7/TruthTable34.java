public class TruthTable34
{
  public static void main(String[] args)
  {
    ...
    System.out.println("p1 = (((a || b) && c) || ((b || c) && d)) && (a || d)");
        ...
        { 
          for (int d = 0; d < 2; d++)
          {
            ...
            System.out.println(FormatCell(ToBool(a)) +
                               ...
                               FormatCell(ToBool(c)) +
                               FormatCell(ToBool(d)) +
                               FormatCell(p1(ToBool(a), ToBool(b), ToBool(c), ToBool(d))) +
                               FormatCell(p2(ToBool(a), ToBool(b), ToBool(c), ToBool(d))) +
                               FormatCell(p3(ToBool(a), ToBool(b), ToBool(c), ToBool(d))) +
                               "|");
          }
        }
      }
